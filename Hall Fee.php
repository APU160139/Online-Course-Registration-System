          ...
          <div class="rows">
            <div class="col-75">
              <div class="container">
                ...
                width: 835px;
                padding-top: 0px;
                background-color: rgb(247, 215, 215);border:15px" >
                
                      <h3 style="background-color: rgb(201, 198, 199); text-align: center"> Hall Fee</h3>
                      ...
                      <input type="file" id="ccnum" name="cardnumber">
                      <div >
